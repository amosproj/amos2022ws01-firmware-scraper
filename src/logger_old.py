...
# Common log messages used by vendors
LOGMSG_START_SCRAPING = "Start scraping."
LOGMSG_STOP_SCRAPING = "Stop scraping."
LOGMSG_ACCESS_ENTRY_URL = "Access entry URL"
...
def create_logger_old(level: str = "IMPORTANT", name: str = "scraper"):
    if level == "INFO":
